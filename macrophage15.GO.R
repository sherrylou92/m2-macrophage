...
setwd("D:\\生信视频\\159.macrophage资料\\159.macrophage资料\\15.GO - 10846")      #设置工作目录
...
bar=barplot(kk, drop=TRUE, showCategory=30, label_format=130, split="ONTOLOGY", color=colorSel) + facet_grid(ONTOLOGY~., scale='free')
print(bar)
dev.off()
		
#气泡图
pdf(file="bubble.pdf", width=30, height=7)
